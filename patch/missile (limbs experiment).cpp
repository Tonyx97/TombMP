...
void ControlBodyPart(int16_t fx_number)
{
	...
	DoProperDetectionFx(fx_number, fx->pos.x_pos, fx->pos.y_pos, fx->pos.z_pos, (fx->speed * phd_sin(fx->pos.y_rot) >> W2V_SHIFT) >> 2, fx->fallspeed, (fx->speed * phd_cos(fx->pos.y_rot) >> W2V_SHIFT) >> 2);
