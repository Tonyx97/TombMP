...
static inline FileListNodeContext FLNC_NO_ACTION	= { 0, 0, 0, 0 };
static inline FileListNodeContext FLNC_DOWNLOAD		= { 1, 0, 0, 0 };
static inline FileListNodeContext FLNC_INFO			= { 2, 0, 0, 0 };
static inline FileListNodeContext FLNC_USE			= { 3, 0, 0, 0 };
static inline FileListNodeContext FLNC_EOF			= { 4, 0, 0, 0 };
